...
app.use(express.static('./public')); //tells your app to look for HTML files inside the views folder whenever it gets a request for a particular page. Set the folder-name from where you serve the html page. 
